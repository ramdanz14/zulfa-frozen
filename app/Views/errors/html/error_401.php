                ...
                <div class="row justify-content-center w-100">
                    <div class="col-lg-4">
                        <div class="text-center">
                            <img src="<?= base_url(); ?>assets/images/backgrounds/website-under-construction.svg" alt="modernize-img" class="img-fluid" width="500">
                            <h1 class="fw-semibold mb-7 fs-9">Opps!!!</h1>
                            <h4 class="fw-semibold mb-7">Anda tidak memiliki akses untuk halaman ini</h4>
