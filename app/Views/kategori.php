            ...
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        ...
                        <p class="mb-0"><span class="page-pretitle">Total</span> | Manajemen Data Kategori.</p>
                    </div>
                    <div class="col-3">
...
<script>
    ...
    function showModal(action, data) {
        ...
        $("#modal-form > .modal-body").append(`<div class="form-group mb-1">
            <label for="kat_id" class="form-label">KATEGORI ID</label>
            <input type="text" class="form-control" name="kat_id" id="kat_id" />
        </div>`);
