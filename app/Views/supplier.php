        ...
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-2">Supplier</h4>
                        <p class="mb-0"><span class="page-pretitle">Total</span> | Manajemen Data Supplier.</p>
                    </div>
                    <div class="col-3">
...
<script>
    ...
    function showModal(action, data) {
        ...
        const list = ['supco', 'nama', 'email', 'kontak', 'alamat'];
        list.forEach((item) => {
